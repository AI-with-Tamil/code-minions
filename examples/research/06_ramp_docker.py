"""
Example 06 — Ramp Sandbox Pattern
==================================
...
Example type:
- Research example
- Pressure test of production-style isolated runtime execution
- Approximation of Ramp's sandbox model using Minion's `DockerEnv`
...
- Integration tests run inside the isolated environment

What is approximated:
- Ramp's Modal/image-registry model is represented here with `DockerEnv`
- pre-warmed image snapshots and richer platform integrations are intentionally omitted
- visual verification is left out so the example stays focused on runtime isolation and service-backed testing
...
from codeminions.tools import CODE_TOOLS, CI_TOOLS, SHELL_TOOLS
