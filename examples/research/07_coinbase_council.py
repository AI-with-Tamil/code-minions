...
Example type:
- Research example
- Pressure test of council-style review inside Minion's ordered blueprint model
- Approximation of a richer multi-agent system without introducing graph orchestration into the SDK core
...
- Domain-specific review criteria written into separate judge nodes
- Parallel review execution with aggregated verdicts

What is approximated:
- this stays inside Minion's ordered/conditional blueprint model rather than reproducing a full graph runtime
- external issue/thread hydration and auto-merge policy are intentionally omitted
- the council is kept to the domains that map cleanly onto current primitives
