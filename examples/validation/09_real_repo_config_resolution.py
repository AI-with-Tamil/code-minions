...
Example type:
- Validation example
- Self-hosting workflow against the SDK repo itself
...
async def main() -> None:
    ...
    task = Task(
        description=(
            "Implement the documented Minion configuration resolution order in src/codeminions/core/minion.py: "
            "constructor args override config files, then codeminions.toml, then pyproject.toml [tool.codeminions], "
    ...
    env = GitWorktreeEnv(
        ...
        base_branch="main",
        branch_prefix="codeminions-real",
